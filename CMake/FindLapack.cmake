    ...
    if(NOT MKL_FOUND)
      ...
      #     if(${CMAKE_SYSTEM_PROCESSOR} MATCHES "x86_64")
        ...
        if(${MKL_VERSION} MATCHES "10\\.2\\.[0-4]")
          ...
          set(mkl_libs "-L$ENV{MKL_HOME};mkl_intel_lp64;mkl_sequential;mkl_core;mkl_solver_lp64_sequential")
...
if(MKL_FOUND)
  ...
  IF($ENV{ATLAS} MATCHES "atlas")
    ...
    IF(QMC_BUILD_STATIC)
      ...
      FIND_LIBRARY(LAPACK_LIBRARIES ${lapack_libs} $ENV{ATLAS}/lib)
      FIND_LIBRARY(F77BLAS_LIBRARIES ${f77blas_libs} $ENV{ATLAS}/lib)
      FIND_LIBRARY(CBLAS_LIBRARIES ${cblas_libs} $ENV{ATLAS}/lib)
      FIND_LIBRARY(ATLAS_LIBRARIES ${atlas_libs} $ENV{ATLAS}/lib)
  ...
  MESSAGE(STATUS "Could not find MKL, specify MKL_HOME")
endif(MKL_FOUND)
