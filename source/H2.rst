...
#. the energy you get is within error bars of the correct answer of
   -1.1744.
#. that the kinetic and potential energy obey the virial theorem:
   :math:`\langle V \rangle = -2\langle K \rangle`. Note that this
   should only be true for coloumb systems
...
#. what temperature the molecule breaks down. This requires:

   #. making the protons quantum (i.e. putting the correct value for
