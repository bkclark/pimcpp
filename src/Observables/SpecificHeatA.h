...
#ifndef SPECIFIC_HEATA_H
#define SPECIFIC_HEATA_H

#include "ObservableBase.h"

class SpecificHeatAClass : public ObservableClass
{
...
private:
  ...
  double ds_dBeta2;
  double d2s_dBeta2;
  ObservableDouble TotalEVar,ds_dBeta2Var,d2sdBeta2Var;
...
public:
  ...
  SpecificHeatAClass(PathDataClass &myPathData, IOSectionClass &ioSection)
    : ObservableClass(myPathData, ioSection) , 
      ...
      TotalEVar("TotalE",IOSection,myPathData.Path.Communicator),
      ds_dBeta2Var("ds_dBeta2",IOSection,myPathData.Path.Communicator),
      d2sdBeta2Var("ds2_dBeta2",IOSection,myPathData.Path.Communicator)
