...
#ifndef REF_STRUCTURE_FACTOR_H
#define REF_STRUCTURE_FACTOR_H

#include "ObservableBase.h"

/// A pair correlation function observable.
class RefStructureFactorClass : public ObservableClass
{
...
public:
  ...
  void Calculate();
  void Clear();
  RefStructureFactorClass(PathDataClass &myPathData, IOSectionClass &ioSection) : 
