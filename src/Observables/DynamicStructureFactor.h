...
#ifndef DYNAMIC_STRUCTURE_FACTOR_H
#define DYNAMIC_STRUCTURE_FACTOR_H

#include "ObservableBase.h"

/// A pair correlation function observable.
class DynamicStructureFactorClass : public ObservableClass
{
  ObservableVecDouble2 SofkVar;
...
public:
  ...
  void Clear();
  DynamicStructureFactorClass(PathDataClass &myPathData, IOSectionClass &ioSection) : 
