...
inline double MyTricubicSpline::d_dx (double x, double y, double z)
{
  if (!UpToDate)
    Update();
...
inline double MyTricubicSpline::d_dy (double x, double y, double z)
{
  if (!UpToDate)
    Update();
...
inline double MyTricubicSpline::d_dz (double x, double y, double z)
{
  if (!UpToDate)
    Update();
...
inline double MyTricubicSpline::d2_dx2 (double x, double y, double z)
{
  if (!UpToDate)
    Update();
...
inline double MyTricubicSpline::d2_dy2 (double x, double y, double z)
{
  if (!UpToDate)
    Update();
...
inline double MyTricubicSpline::d2_dz2 (double x, double y, double z)
{
  if (!UpToDate)
    Update();
...
inline double MyTricubicSpline::Laplacian (double x, double y, double z)
{
  if (!UpToDate)
    Update();
...
inline double MyTricubicSpline::d2_dxdy (double x, double y, double z)
{
  if (!UpToDate)
    Update();
...
inline double MyTricubicSpline::d2_dxdz (double x, double y, double z)
{
  if (!UpToDate)
    Update();
...
inline double MyTricubicSpline::d2_dydz (double x, double y, double z)
{
  if (!UpToDate)
    Update();
