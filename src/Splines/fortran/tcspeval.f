...
c
c      real*8 fval(ivd,10)
c      real*8 xv(ivd),yv(ivd),zv(ivd)
c      integer iv(ivd),jv(ivd),kv(ivd)
c      real*8 dxv(ivd),dyv(ivd),dzv(ivd)
c      integer ict(10)
c
c      real*8 fspline(4,4,4,nx,ny,nz)  ! spline coeffs
...
c  local --
c
ccc      real*8 p(4)  use p1,p2,p3,p4 now
c
