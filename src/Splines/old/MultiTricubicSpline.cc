...
void MultiTricubicSpline::UpdateX(int source, int dest, int n)
{
  Grid &x = *Xgrid;
...
void MultiTricubicSpline::UpdateY(int source, int dest, int n)
{
  Grid &y = *Ygrid;
...
void MultiTricubicSpline::UpdateZ(int source, int dest, int n)
{
  Grid &z = *Zgrid;
