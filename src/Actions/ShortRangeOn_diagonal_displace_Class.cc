...
///particles it has
void ShortRangeOn_diagonal_displace_class::AcceptCopy (int slice1, int slice2)
{
  distancesNew.clear();
  distancesOld.clear();
...
void ShortRangeOn_diagonal_displace_class::RejectCopy (int slice1, int slice2)
{
  distancesNew.clear();
  factorArrayNew.clear();
...
double 
ShortRangeOn_diagonal_displace_class::residual_energy()
{
...
void
ShortRangeOn_diagonal_displace_class::GradAction_help(int slice1, int slice2, 
...
void ShortRangeOn_diagonal_displace_class::Read(IOSectionClass& in)
{
...
ShortRangeOn_diagonal_displace_class::ShortRangeOn_diagonal_displace_class(PathDataClass &pathData,
...
double 
ShortRangeOn_diagonal_displace_class::SingleAction_fast (int slice1, int slice2,
...
double 
ShortRangeOn_diagonal_displace_class::SingleAction (int slice1, int slice2,
				 const Array<int,1> &changedParticles,
				 int level)
{
#if NDIM==2
...
double 
ShortRangeOn_diagonal_displace_class::SingleAction_slow (int slice1, int slice2,
				 const Array<int,1> &changedParticles,
				 int level)
{
  struct timeval start, end; 
 ...
 double 
 ShortRangeOn_diagonal_displace_class::d_dBeta (int slice1, int slice2,
				       int level)
{
...
double 
ShortRangeOn_diagonal_displace_class::d_dBeta_slow(int slice1, int slice2,int level)
{
  PathClass &Path = PathData.Path;
  int xEffect=Path.Cell.Xeffect;
  int yEffect=Path.Cell.Yeffect;
...
// double ShortRangeOn_diagonal_displace_class::d_dBeta (int slice1, int slice2,
// 				 int level)
// {
...
string 
ShortRangeOn_diagonal_displace_class::GetName()
{
  return "ShortRangeOn_diagonal_displace";
}
