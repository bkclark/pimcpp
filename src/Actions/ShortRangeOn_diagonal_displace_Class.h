...
#ifndef SHORT_RANGE_ON_DIAGONAL_DISPLACE_CLASS_H
#define SHORT_RANGE_ON_DIAGONAL_DISPLACE_CLASS_H
...
class ShortRangeOn_diagonal_displace_class : public ActionBaseClass
{
protected:
...
public:
  ...
  void GradAction_help(int slice1, int slice2,
		       ...
		       Array<dVec,1> &gradVec,
		       Array<double,1> &gradVecSquared);
  ShortRangeOn_diagonal_displace_class (PathDataClass &pathData,
			       Array<PairActionFitClass*, 2> &pairMatrix);
};
